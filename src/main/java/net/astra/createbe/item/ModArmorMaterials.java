...
public enum ModArmorMaterials implements ArmorMaterial {
    AETERNIUMDIVING("aeterniumdiving",25,new int[] { 4, 9, 7, 4 }, 19,
        SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE,3.5f,0.2f, () -> Ingredient.ofItems(ModItems.OLE));
    ...
    public String getName() {
        return CreateBetterEnd.MOD_ID + ":" + this.name;
    }
